...
import {flowers} from '../../assets/data/flowers.js'
...
export default function FeaturedList() {
  ...
  const onPressOut = () => {
    ...
    const onLongPress = (selected: React.SetStateAction<{ name: string; description: string; image: string }>)=>{
    ...
    <>
        ...
        <View style={styles.container}>
            ...
            renderItem={({ item }) => (
              <Animated.View style={
                selected === item ?
                [styles.card, { transform: [{ scale: scaleValue }]}]
                :
                ""
                }>
                  <Pressable
